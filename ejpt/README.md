...
- 🔬 For the **training** part I will use the [Attack-Defense](https://attackdefense.pentesteracademy.com/members) environment from PentesterAcademy (`subscription required`).
